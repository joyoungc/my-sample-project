...
public class ProductDTO {
	...
	public static class Create {
		...
		@ApiModelProperty(value = Constants.PRODUCT_NAME, required = true, example = "Sample Product", position = Constants.PRODUCT_NAME_POS)
		@NotBlank
	...
	public static class Response {
		...
		@ApiModelProperty(value = Constants.PRODUCT_ID, required = true, example = "P100003" , position = Constants.PRODUCT_ID_POS)		
		public String getProductId() {
			return productId;
		}
		
		@ApiModelProperty(value = Constants.PRODUCT_NAME, required = true, example = "LG G6", position = Constants.PRODUCT_NAME_POS)
		public String getProductName() {
			return productName;
		}
